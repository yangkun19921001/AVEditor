...
//        player_view.setDataSource("/sdcard/aveditor/123.h264");
        player_view.setDataSource("sdcard//aveditor/test.mp4");
...
//        else
        ...
        player_view.start()
        dy_seekbar.visibility=View.VISIBLE
...
//                var seelV = seekBar.progress.toDouble() / dy_seekbar.max.toDouble()
                player_view.seekTo(seekBar.progress.toDouble())
            }
        })

        player_view.addProgressListener(object : AVPlayView.OnProgressListener {
