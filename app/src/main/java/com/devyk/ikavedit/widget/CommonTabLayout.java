...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mSelectTextsize = ta.getDimension(R.styleable.CommonTabLayout_tl_textsize, sp2px(16f));
        mUnSelectTextsize = sp2px(12f);
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setTextsize(float selectTextSize,float unSelectTextSize) {
        this.mSelectTextsize = sp2px(selectTextSize);
        this.mUnSelectTextsize = sp2px(unSelectTextSize);
        updateTabStyles();
    }
