...
/**
 * <pre>
 *     author  : devyk on 2020-04-25 16:46
...
//		System.loadLibrary("c++_shared");
	...
	public static void open(boolean isLoadLib, int level, int mode, String cacheDir, String logDir, String nameprefix, int cacheDay,String pubkey) {
		appenderOpen(level, mode, cacheDir, logDir, nameprefix, cacheDay, pubkey);
		Xlog.setConsoleLogOpen(isLoadLib);
	}
