...
class AVToolsSweetsFilter(context: Context) : GPUImageFilter(context,NO_FILTER_VERTEX_SHADER, OpenGLUtils.readRawTextFile(context,
    R.raw.sweets)) {
    ...
    private var mMaskGrey1UniformLocation: Int = 0
    private var mLowPerformanceUniformLocation: Int = 0
