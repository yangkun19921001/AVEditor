...
class GPUImageAlphaBlendFilter : GPUImageMixBlendFilter {
    ...
    constructor(context: Context) : super(context,ALPHA_BLEND_FRAGMENT_SHADER) {}

    constructor(context: Context,mix: Float) : super(context,ALPHA_BLEND_FRAGMENT_SHADER, mix) {}
