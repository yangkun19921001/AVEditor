 ...
 * D = C1 + C2 * C2a * (1 - C1a)
 */
class GPUImageNormalBlendFilter(context: Context) : GPUImageTwoInputFilter(context,NORMAL_BLEND_FRAGMENT_SHADER) {
    companion object {
        val NORMAL_BLEND_FRAGMENT_SHADER = "varying highp vec2 textureCoordinate;\n" +
