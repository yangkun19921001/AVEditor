...
class GPUImageSaturationBlendFilter(context: Context) : GPUImageTwoInputFilter(context,SATURATION_BLEND_FRAGMENT_SHADER) {
    companion object {
        val SATURATION_BLEND_FRAGMENT_SHADER = "varying highp vec2 textureCoordinate;\n" +
