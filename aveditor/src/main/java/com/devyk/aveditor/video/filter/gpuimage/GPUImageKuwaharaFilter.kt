 ...
 */
class GPUImageKuwaharaFilter @JvmOverloads constructor(context: Context,private var radius: Int = 3) :
    GPUImageFilter(context,NO_FILTER_VERTEX_SHADER, KUWAHARA_FRAGMENT_SHADER) {
