...
class GPUImageDivideBlendFilter(context: Context) : GPUImageTwoInputFilter(context,DIVIDE_BLEND_FRAGMENT_SHADER) {
    companion object {
        val DIVIDE_BLEND_FRAGMENT_SHADER = "varying highp vec2 textureCoordinate;\n" +
