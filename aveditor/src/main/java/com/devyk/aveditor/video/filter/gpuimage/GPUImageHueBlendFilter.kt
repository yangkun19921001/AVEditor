...
class GPUImageHueBlendFilter(context: Context) : GPUImageTwoInputFilter(context,HUE_BLEND_FRAGMENT_SHADER) {
    companion object {
        val HUE_BLEND_FRAGMENT_SHADER = "varying highp vec2 textureCoordinate;\n" +
