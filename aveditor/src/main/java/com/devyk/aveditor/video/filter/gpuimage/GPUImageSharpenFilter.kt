 ...
 */
class GPUImageSharpenFilter @JvmOverloads constructor(context: Context,private var sharpness: Float = 0.0f) :
    GPUImageFilter(context,SHARPEN_VERTEX_SHADER, SHARPEN_FRAGMENT_SHADER) {
