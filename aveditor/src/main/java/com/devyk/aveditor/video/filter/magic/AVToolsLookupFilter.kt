...
open class AVToolsLookupFilter(context: Context, protected var table: String) :
    GPUImageFilter(context,NO_FILTER_VERTEX_SHADER, LOOKUP_FRAGMENT_SHADER) {

    var mLookupTextureUniform: Int = 0
    ...
    protected override fun onInitialized() {
        super.onInitialized()
        runOnDraw(Runnable { mLookupSourceTexture = OpenGLUtils.loadTexture(context, table) })
    }
