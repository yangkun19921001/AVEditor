...
import com.devyk.ffmpeglib.entity.MediaInformationParser;
...
public class FFprobe {
    ...
    static {
        ...
        com.devyk.ffmpeglib.config.Config.class.getName();
    }
    ...
    public static int execute(final String[] arguments) {
        final int lastReturnCode = com.devyk.ffmpeglib.config.Config.nativeFFprobeExecute(arguments);

        com.devyk.ffmpeglib.config.Config.setLastReturnCode(lastReturnCode);
    ...
    private static MediaInformation getMediaInformationFromCommandArguments(final String[] arguments) {
        ...
        if (rc == 0) {
            return MediaInformationParser.from(com.devyk.ffmpeglib.config.Config.getLastCommandOutput());
        } else {
            Log.w(Config.TAG, com.devyk.ffmpeglib.config.Config.getLastCommandOutput());
            return null;
        }
    }
